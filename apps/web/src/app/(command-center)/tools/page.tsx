    ...
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-0.5 text-sm text-zinc-500">Security toolkit management and configuration</p>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-white/10 bg-white/[0.02] py-20">
        ...
        <p className="text-sm font-medium text-zinc-400">Tool management coming soon</p>
        <p className="mt-1 text-xs text-zinc-600">Configure and orchestrate your security toolkit</p>
      </div>
    </div>
  );
}
